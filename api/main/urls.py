...
#GET favorites/vacancy/ favorites/cv/
    path('favorites/vacancy/<int:id>', FavoriteUserView.as_view(), name='favorite_user_vacancy'),
    path('favorites/cv/<int:id>', FavoriteUserView.as_view(), name='favorite_user_cv'),
