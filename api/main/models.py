...
class Vacancy(models.Model):
    ...
    address = models.JSONField(max_length=700, blank=True, null=True, default=default_dict())
...
class Worker(models.Model):
    ...
    address = models.JSONField(max_length=100, blank=True, null=True, default=default_dict())
    phone = models.JSONField(max_length=100, blank=True, null=True, default=default_dict())
    about = models.TextField(blank=True, null=True, default=default_str())
